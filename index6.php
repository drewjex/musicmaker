<html>
    ...
    <body>
        <?php
            ...
            $music_maker = new MusicMaker("Ttest", "Drew Jex");
            ...
            /*$music_maker->convertMidiToMM("save/WAYDECE1.mid"); //there's still some weird bugs here or something...
            echo "COOL";
            $music_maker->generateMidiFile();
            echo "WAHT";
            $music_maker->saveMidiSong();
            echo "WAIT";*/
            $music_maker->song->title = "WAYDECE1";
            $music_maker->playSong();
